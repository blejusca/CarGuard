        ...
        return try {
            ...
            if (totalImportant > 0) {
                ...
                val message = buildString {
                    ...
                    if (expiredCount > 0) append(" Expirate: $expiredCount.")
                    if (todayCount > 0) append(" Expira azi: $todayCount.")
                    if (tomorrowCount > 0) append(" Expira maine: $tomorrowCount.")
                    if (soonCount > 0) append(" In curand: $soonCount.")
                    if (clientsToNotify > 0) append(" Clienti de notificat: $clientsToNotify.")
                }
