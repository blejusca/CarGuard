...
private fun WhatsAppNotifyButton(
    ...
    val text = when {
        isManuallyNotified -> "Client notificat \u2713"
    ...
    AlertDialog(
        ...
        confirmButton = {
            Button(
                ...
                Text(text = "Da, sterge", color = Color.White, fontWeight = FontWeight.Bold)
            }
        },
        dismissButton = {
            Button(
                ...
                Text(text = "Anuleaza", color = AppColors.Navy, fontWeight = FontWeight.Bold)
            }
        }
    )
}
